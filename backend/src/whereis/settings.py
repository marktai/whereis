...
ALLOWED_HOSTS = ['*']
CSRF_TRUSTED_ORIGINS = ['http://*', 'http://localhost', 'http://localhost:7080', 'http://whereis.marktai.com', 'https://whereis.marktai.com']
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': (
        ...
        'whereis.middleware.CsrfExemptSessionAuthentication',
    ),
